...
0. [Exercise 00 : First shell script](#exercise-00-first-shell-script)
1. [Exercise 01 : Transforming JSON to CSV](#exercise-01-transforming-json-to-csv)
2. [Exercise 02 : Sorting a file](#exercise-02-sorting-a-file)
3. [Exercise 03 : Replacing strings in a file](#exercise-03-replacing-strings-in-a-file)
4. [Exercise 04 : Descriptive statistics](#exercise-04-descriptive-statistics)
5. [Exercise 05 : Partitioning and concatenation](#exercise-05-partitioning-and-concatenation)
